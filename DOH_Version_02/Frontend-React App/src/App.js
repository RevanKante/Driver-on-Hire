...
import ForgotPassword from './Components/ForgotPassword_1';
import UpdateProfile from './Components/UpdateProfile_1';
import DriverHome from './Components/DriverHome_1';
import DriverDashBooking_1 from './Components/DriverDashBooking_1';
import DriverBookingConfirmation from './Components/DriverBookingConfirmation_1';
import DriverDashboardNav from './Components/DriverDashboardNav ';
import UpdateDriverProfile from './Components/UpdateDriverProfile_1 ';
  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route path="/driverdash" element={<DriverDashboardNav />} />
        <Route path="/driverdashbooking" element={<DriverDashBooking_1 />} />
        {/* <Route path="/driverdashpayment" element={<DriverDash />} /> */}
        ...
        <Route path="/todaysrides" element={<TodaysBookings />} />
        <Route path="/addnewcity" element={<AddCity />} />
