...
export default function AdminHome() {
   ...
   /* useEffect(() => {
    ...
    const navigateToTodaysRides = () => {
        navigate('/todaysrides');
    }
         ...
         <div>
            <div className="container-fluid">
                <div className="row">
                    ...
                    <a href="" onClick={navigateToTodaysRides}>   <h3> See Todays Rides</h3> </a>
                    <a href="" onClick={navigateToAddCity}>   <h3> Add New City</h3> </a>
                    </div>
