...
import styles from "./newbook_1.css";
...
export default function BookingForm1_1() {
    ...
    const submitData = (ev) => {
        ...
        // console.log(JSON.parse(localStorage.getItem("BookingForm1Data")));  {...register("endcity", { required: { value: true, message: "You need to specify a valid email address" } })} 
                ...
                <div className="col-md-12">
                    <form className="form-inline" onLoad={dispatch}><br /><br /><br />
                        ...
                        <div className="form-group">
                            ...
                            <div >
                                <input className="form-control" type="text" onChange={handleInput} name="endcity" placeholder="Travelling place name" /></div>
                        </div>
