...
import CustDashBooking from "./DriverDashBooking_1";
...
export default function DriverDashboardNav() {
                                    ...
                                    <div className="col-lg-10 col-md-9">
                                        <div className="row align-items-end">
                                            <div className="col-md-7 text-md-start mt-4 mt-sm-0">
                                                ...
                                                <button className="btn btn-primary" style={{ width: "200px", marginLeft: "800px" }} onClick={navigateToDriverHome} href="">Return to Home page</button>
