...
//import styles from './006_0_register.css'
                    ...
                    <section className="row justify-content-center">
                        <section className="col-12 col-sm-6 col-md-4">
                            ...
                            <form className="inline">
                                ...
                                <button type="submit" onClick={this.sendData} className="btn btn-primary mt-2" disabled={!this.state.formvalid}>Create Account</button>
                            </form>
                        </section>
                    </section>
                </div>
